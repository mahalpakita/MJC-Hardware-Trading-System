        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white topbar mb-4 static-top shadow" style="position: relative; z-index: 1;">
          ...
          <div class="d-flex justify-content-center flex-grow-1">
            <a class="sidebar-brand d-flex align-items-center justify-content-center text-decoration-none" href="index.php">
              <div class="sidebar-brand-icon rotate-n-15 d-none d-lg-block">
                <i class="fas fa-laugh-wink"></i>
              </div>
              <div class="sidebar-brand-text mx-3 d-none d-lg-block">Sales and Inventory System</div>
              <div class="sidebar-brand-text mx-3 d-lg-none">SIS</div>
            </a>
          </div>
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link" href="pos.php" role="button">
                  ...
                  <span class="d-none d-lg-inline text-gray-600">POS</span>
                </a>
              </li>
