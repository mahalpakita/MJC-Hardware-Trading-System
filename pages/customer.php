                        ...
                        <table class="table table-hover align-middle" id="dataTable">
                            ...
                            <tbody>
                                ...
                                if ($rowUser = mysqli_fetch_assoc($resultUser)) {
                                    ...
                                    $query = "SELECT c.CUST_ID, c.FIRST_NAME, c.LAST_NAME, c.PHONE_NUMBER, b.BRANCH_NAME 
                                            FROM customer c 
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '<td class="text-center">
                                                <div class="dropdown">
                                                    <button class="btn btn-light btn-sm rounded-pill dropdown-toggle" type="button" id="dropdownMenuButton' . $row['CUST_ID'] . '" data-bs-toggle="dropdown" aria-expanded="false">
                                                        Actions
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="dropdownMenuButton' . $row['CUST_ID'] . '">
                                                        <li>
                                                            <a class="dropdown-item" href="cust_searchfrm.php?action=edit&id=' . $row['CUST_ID'] . '">
                                                                <i class="fas fa-eye me-2 text-info"></i>Details
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="cust_edit.php?action=edit&id=' . $row['CUST_ID'] . '">
                                                                <i class="fas fa-edit me-2 text-warning"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="cust_del.php?action=delete&id=' . $row['CUST_ID'] . '" 
